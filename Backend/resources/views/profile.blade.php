...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="main-nav" id="main-nav-menu">
            ...
            <div class="nav-item active has-dropdown">PROFILE <i class="fas fa-caret-right"></i>
                <div class="dropdown-content profile-dropdown">
                    <a href="profile.html#tentang">TENTANG</a>
    ...
    <section id="tentang" class="profile-section about-hero">
        <div class="container">
        <img src="FOTO PROFILE/kappframework-VphNwN(1)(1).png" alt="Foto About Us">
        </div>
        <div class="overlay"> 
        <div class="text">
    ...
    <section id="dikdasmen" class="profile-section">
        <img src="FOTO BERANDA/dikdesmen.png">
        <div class="logo-box">
            <p> Majelis Pendidikan Dasar Menengah dan Pendidikan Nonformal
            Pimpinan Pusat Muhammadiyah sebagai lembaga mitra lokal bekerja 
            sama dengan Save the Children menyelenggarakan Program Kolaborasi 
            Edukasi Untuk Anak Indonesia (KREASI) yang berfokus pada penguatan 
            literasi, Numerasi, dan Karakter Murid Madrasah Ibtidaiyah/Sekolah 
            Dasar dan Raudatul Athfal di wilayah Kalimantan Barat dengan 2 
            Kabupaten yaitu Ketapang dan Kayong Utara.
            </p>
        </div>
    </section>
    ...
    <section id="kreasi" class="profile-section kreasi">
        <div class="left">
        <img src="FOTO BERANDA/KREASI-SYMBOL_KREASI--768x416.png" class="logo-kreasi">
        </div>
        <div class="right">
        <p>
            (Kolaborasi untuk Edukasi Anak Indonesia) merupakan program yang didanai oleh
            Global Partnership for Education (GPE), dan dikembangkan bersama Kementerian
            Pendidikan Dasar dan Menengah & Kementerian Agama, dan melalui Save The Children
            dalam konsorsium kolaboratif Mitra Pendidikan Indonesia (MPI).
        </p>
    </div>
    </section>
...
<section id="tujuan" class="profile-section tujuan-box">
    <h2>TUJUAN</h2>
    <p>
        KREASI bertujuan untuk meningkatkan kualitas pendidikan di Indonesia dengan memperkuat 
        pengajaran, pembelajaran, dan pengembangan siswa. KREASI melalui Agen Hibahnya, 
        Save the Children Australia dan Save the Children Indonesia sebagai perwakilan 
        di Indonesia, ditunjuk oleh Kementerian Pendidikan Dasar dan Menengah (Kemen Dikdasmen) 
        dan Kementerian Agama (Kemenag), dengan dukungan dari Mitra Pendidikan Indonesia (MPI), 
        sebuah konsorsium yang terdiri dari 17 organisasi pemangku kepentingan pendidikan 
        internasional dan lokal. Program KREASI selaras dengan tujuan pendidikan nasional 
        Indonesia yang menekankan proses pembelajaran esensial dan fleksibel yang disesuaikan 
        dengan minat, bakat, dan kebutuhan setiap siswa, dengan fokus pada pendidikan holistik, 
...
<section id="program" class="profile-section split-kreasi">
    <div class="split-left">
        <div class="image-container">
            <img src="FOTO PROFILE/IMG_8446.JPG" alt="logo program kreasi">
...
<section class="STRUKTUR ORGANISASI">
  ...
  <div class="struktur-container">
      ...
      <img src="Foto Struktur organisasi\2.png" class="img-pop-tim" alt="struktur">
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\3.png" class="img-pop-tim" alt="struktur">
  ...
  <div class="struktur-container">
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\5.png" class="img-pop-tim" alt="struktur">
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\6.png" class="img-pop-tim" alt="struktur">
...
<br>KREASI Kabupaten Ketapang</p>
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\11.png" class="img-pop-tim" alt="struktur">
...
<br>KREASI Kabupaten Ketapang</p>
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\9.png" class="img-pop-tim" alt="struktur">
...
<br>KREASI Kabupaten Ketapang</p>
  ...
  <div class="struktur-container">
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\4.png" class="img-pop-tim" alt="struktur">
...
<br>KREASI Kabupaten Ketapang</p>
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\8.png" class="img-pop-tim" alt="struktur">
...
<br>KREASI Kabupaten Ketapang</p>
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\7.png" class="img-pop-tim" alt="struktur">
...
<br>KREASI Kabupaten Ketapang</p>
    ...
    <div class="card-struktur">
      <img src="Foto Struktur organisasi\10.png" class="img-pop-tim" alt="struktur">
