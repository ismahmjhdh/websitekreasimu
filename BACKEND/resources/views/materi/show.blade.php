...
<body>
    ...
    <footer class="footer">
            ...
            <div class="footer-right">
                ...
                <div class="social-icons">
                    ...
                    <a href="https://x.com/savechildren_id" target="_blank">
                        <img src="{{ asset('images/FOOTER/Twitter_X.png') }}" alt="Twitter">
                    </a>
        ...
        <div class="logo-row">
            <img src="{{ asset('images/FOOTER/Tut wuri handayani1.png') }}" alt="Logo">
            <img src="{{ asset('images/FOOTER/Kementerian_Agama_new_logo.png') }}" alt="Logo">
            <img src="{{ asset('images/FOOTER/Logo_Kementerian_PPN-Bappenas_(2023).png') }}" alt="Logo">
            <img src="{{ asset('images/FOOTER/Lambang_Daerah_Kab._Kayong_Utara.png') }}" alt="Logo">
            <img src="{{ asset('images/FOOTER/GPE-removebg-preview.png') }}" alt="Logo">
            <img src="{{ asset('images/FOTO BERANDA/KREASI-SYMBOL_KREASI--768x416.png') }}" alt="Logo">
            <img src="{{ asset('images/FOOTER/Logo_SavetheChildren.png') }}" alt="Logo">
            <img src="{{ asset('images/FOTO BERANDA/dikdesmen.png') }}" alt="Logo">
        </div>
    </footer>
