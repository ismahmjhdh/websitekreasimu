...
Route::middleware(['admin.auth', 'admin.security'])->group(function () {
    ...
    Route::get('/admin/users', [AdminController::class, 'adminIndex'])->name('admin.users.index');
    Route::get('/admin/users/create', [AdminController::class, 'adminCreate'])->name('admin.users.create');
    Route::post('/admin/users', [AdminController::class, 'adminStore'])->name('admin.users.store');
    Route::get('/admin/users/{id}/edit', [AdminController::class, 'adminEdit'])->name('admin.users.edit');
    Route::post('/admin/users/{id}', [AdminController::class, 'adminUpdate'])->name('admin.users.update');
    Route::post('/admin/users/{id}/delete', [AdminController::class, 'adminDelete'])->name('admin.users.delete');

    // Change Password
    Route::get('/admin/change-password', [AdminController::class, 'changePasswordForm'])->name('admin.change-password.form');
