...
<body>
    ...
    <header class="main-header">
        ...
        <nav class="main-nav" id="main-nav-menu">
            ...
            <a href="materi.html" class="nav-item active">MATERI</a>
    ...
    <main class="main-content materi-layout">
        ...
        <div class="filter-bar">
             <div class="filter-group">
                ...
                <span><input type="checkbox" name="jenjang"> SD</span>
                <span><input type="checkbox" name="jenjang"> SMP</span>
                <span><input type="checkbox" name="jenjang"> SMA/K</span>
            </div>
