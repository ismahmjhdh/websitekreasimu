...
<footer class="footer">
  <div class="footer-content">
    ...
    <div class="footer-right">
      ...
      <div class="social-icons">
        <a href="https://www.facebook.com/SaveChildrenID/" target="_blank"> <img src="{{asset (path: 'images/FOOTER\Facebook_font_awesome.svg.png')}}"> </a>
        <a href="https://www.instagram.com/savechildren_id" target="_blank"> <img src="{{asset (path: 'images/FOOTER\Instagram.png')}}"></a>
        <a href="https://x.com/savechildren_id" target="_blank"> <img src="{{asset (path: 'images/FOOTER\Twitter_X.png')}}"></a>
        <a href="https://www.linkedin.com/company/savethechildren-indonesia/" target="_blank"> <img src="{{asset (path: 'images/FOOTER\LinkedIn_logo_In-Black.svg.png')}}"></a>
  ...
  <!-- Logo Bar -->
  <div class="logo-row">
    <img src="{{asset (path: 'images/FOOTER\Tut wuri handayani.png')}}" alt="">
    <img src="{{asset (path: 'images/FOOTER\Kementerian_Agama_new_logo.png')}}" alt="">
    <img src="{{asset (path: 'images/FOOTER\Logo_Kementerian_PPN-Bappenas_(2023).png')}}" alt="">
    <img src="{{asset (path: 'images/FOOTER\Lambang_Daerah_Kab._Kayong_Utara.png')}}" alt="">
    <img src="{{asset (path: 'images/FOOTER\GPE.png')}}" alt="">
    <img src="{{asset (path: 'images/FOTO BERANDA\KREASI-SYMBOL_KREASI--768x416.png')}}" alt="">
    <img src="{{asset (path: 'images/FOOTER\Logo_SavetheChildren.png')}}" alt="">
    <img src="{{asset (path: 'images/FOTO BERANDA\dikdesmen.png')}}" alt="">
  </div>
</footer> 
